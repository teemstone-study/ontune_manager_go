...
func (r *RealtimeperfPgArr) SetData(data interface{}, agenttime time.Time, ids ...int) {
	d := data.(RealtimeperfPg)
	r.Ontunetime = append(r.Ontunetime, agenttime.Unix())
	r.Agenttime = append(r.Agenttime, int(agenttime.Unix()))
	r.Agentid = append(r.Agentid, d.Agentid)
	...
	r.Pagingspaceout = append(r.Pagingspaceout, d.Pagingspaceout)
	r.Filesystemin = append(r.Filesystemin, d.Filesystemin)
	r.Filesystemout = append(r.Filesystemout, d.Filesystemout)
	...
	r.Networkiops = append(r.Networkiops, d.Networkiops)
...
func (r *RealtimeperfPgArr) GetInsertStmt(tablename string) string {
	return fmt.Sprintf(InsertRealtimePerfUnnest, tablename, "int")
}

func (r *RealtimeperfPgArr) GetArgs() []interface{} {
	data := make([]interface{}, 0)
...
func (a *RealtimeperfPgArr) GetArrString() []string {
	arr := make([]string, 0)
	size := len(a.Agentid)
...
func (r *RealtimeperfTsArr) SetData(data interface{}, agenttime time.Time, ids ...int) {
	d := data.(RealtimeperfTs)
...
func (r *RealtimeperfTsArr) GetInsertStmt(tablename string) string {
	return fmt.Sprintf(InsertRealtimePerfUnnest, tablename, "timestamptz")
}

func (r *RealtimeperfTsArr) GetArgs() []interface{} {
	data := make([]interface{}, 0)
	data = append(data, pq.Array(r.Ontunetime))
	data = append(data, pq.Array(r.Agenttime))
	data = append(data, pq.Array(r.Agentid))
...
func (a *RealtimeperfTsArr) GetArrString() []string {
	arr := make([]string, 0)
	size := len(a.Agentid)
...
func (r *RealtimecpuPgArr) SetData(data interface{}, agenttime time.Time, ids ...int) {
	d := data.(RealtimecpuPg)
	r.Ontunetime = append(r.Ontunetime, agenttime.Unix())
	r.Agenttime = append(r.Agenttime, int(agenttime.Unix()))
	r.Agentid = append(r.Agentid, d.Agentid)
	r.Index = append(r.Index, d.Index)
	r.User = append(r.User, d.User)
	r.Sys = append(r.Sys, d.Sys)
	r.Wait = append(r.Wait, d.Wait)
	r.Idle = append(r.Idle, d.Idle)
...
func (r *RealtimecpuPgArr) GetInsertStmt(tablename string) string {
	return fmt.Sprintf(InsertRealtimeCpuUnnest, tablename, "int")
}

func (r *RealtimecpuPgArr) GetArgs() []interface{} {
	data := make([]interface{}, 0)
	data = append(data, pq.Array(r.Ontunetime))
	data = append(data, pq.Array(r.Agenttime))
	data = append(data, pq.Array(r.Agentid))
...
func (a *RealtimecpuPgArr) GetArrString() []string {
	arr := make([]string, 0)
	size := len(a.Agentid)
...
func (r *RealtimecpuTsArr) SetData(data interface{}, agenttime time.Time, ids ...int) {
	d := data.(RealtimecpuTs)
	r.Ontunetime = append(r.Ontunetime, agenttime)
	r.Agenttime = append(r.Agenttime, int(agenttime.Unix()))
	r.Agentid = append(r.Agentid, d.Agentid)
	r.Index = append(r.Index, d.Index)
...
func (r *RealtimecpuTsArr) GetInsertStmt(tablename string) string {
	return fmt.Sprintf(InsertRealtimeCpuUnnest, tablename, "timestamptz")
}

func (r *RealtimecpuTsArr) GetArgs() []interface{} {
	data := make([]interface{}, 0)
	data = append(data, pq.Array(r.Ontunetime))
	data = append(data, pq.Array(r.Agenttime))
	data = append(data, pq.Array(r.Agentid))
...
func (a *RealtimecpuTsArr) GetArrString() []string {
	arr := make([]string, 0)
	size := len(a.Agentid)
