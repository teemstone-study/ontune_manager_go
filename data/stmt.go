...
INSERT INTO %s
(select * from unnest(
	$1::int[],$2::%s[],$3::int[],$4::int[],$5::int[],$6::int[],$7::int[],$8::int[],$9::int[],$10::int[],$11::int[],$12::int[],$13::int[],$14::int[],$15::int[],$16::int[],$17::int[],$18::int[],$19::int[],$20::int[],
...
INSERT INTO %s
(select * from unnest(
	$1::int[],$2::%s[],$3::int[],$4::int[],$5::int[],$6::int[],$7::int[],$8::int[],$9::int[],$10::int[],$11::int[],$12::int[],$13::int[],$14::int[]
))
`
...
INSERT INTO %s
(select * from unnest(
	$1::int[],$2::%s[],$3::int[],$4::int[],$5::int[],$6::int[],$7::int[],
